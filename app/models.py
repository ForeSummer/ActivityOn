...
class UserBase (models.Model):
    ...
    UFollow = models.CharField(blank=True,max_length = 10)
    UFollowed = models.CharField(blank=True,max_length = 10)
    UMessage = models.CharField(blank=True,max_length = 10)
...
class UserTimeline(models.Model):
    UId = models.AutoField(primary_key=True)
    UTimelineFrom = models.CharField(max_length=10)
    UTimelineAct = models.CharField(max_length=10)
...
class Activity(models.Model):
    ...
    ARegister = models.CharField(blank=True,max_length=30)
